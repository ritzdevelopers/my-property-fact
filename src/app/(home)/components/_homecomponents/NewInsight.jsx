    ...
    <>
      <section className="expert-section ">
        <div className="container expert-container">
          <div className="expert-header mb-2">
          ...
          <div className="expert-layout">
            <div className="left-card">
              <div
                ...
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === "Enter" && setActiveTool("emi")}
              >
              ...
              <div
                ...
                role="button"
                tabIndex={0}
                onKeyDown={(e) => e.key === "Enter" && setActiveTool("locate")}
              >
                <div className="icon-box">
            ...
            <div className="right-card">
              {
                activeTool === "emi" ? (
                  <>
                    ...
                    <h3 className="expert-detail-title">
                      Master Your Mortgage with the EMI Calculator
                    </h3>
                    <p className="expert-detail-desc">
