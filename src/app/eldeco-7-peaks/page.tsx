          ...
          >
            <div className="flex w-[min(1219px,calc(100%-48px))] flex-col items-center gap-[23px]">
              ...
              <p className="-mt-2.5 mb-0 max-w-[1219px] font-[family-name:var(--font-7peaks-cormorant)] text-[28px] leading-[1.46] max-[800px]:text-[22px] max-[800px]:leading-[1.4]">
                Eldeco 7 Peaks Residences in Greater Noida offers premium 3 & 4
                BR residences in Omicron 1A, Greater Noida. Designed for modern
                luxury living, the project combines spacious residences,
                oversized terraces and lush green surroundings. Starting at
                ₹2.37 Cr*, Eldeco 7 Peaks is positioned as a premium residential
                address for homebuyers looking for expansive living spaces and a
                nature-centric lifestyle in Greater Noida. <br />
                Pay 10% now and nothing for 24 months**. Explore Eldeco 7 Peaks
                Residences today.
              </p>
