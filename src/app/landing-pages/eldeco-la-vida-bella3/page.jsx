...
function Home() {
    ...
    useEffect(() => {
        ...
        async function submitToGoogleSheet(formData, submitButton, formElement) {
            ...
            try {
                ...
                setTimeout(() => {
                    ...
                    window.location.href = "/landing-pages/eldeco-la-vida-bella/thanks";
                }, 500);
            } catch (err) {
                submitButton.disabled = false;
                submitButton.innerHTML = originalButtonText;
        ...
        const onPopupSubmit = async function (e) {
            ...
            const sb = this.querySelector("button[type=\"submit\"]");
            submitToGoogleSheet({ name, contact, email, message: document.getElementById("popupMessage")?.value?.trim() || "", project: "", Date: new Date().toISOString() }, sb, this);
        };
                    ...
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <a href="#" className="download-btn mt-4" id="downloadBrochureBtn">
                                Download Brochure <img src="/eldeco-la-vida-bella-images2/images/downloan-icon.png" alt="Download Brochure Icon" title="Download Brochure Icon" /></a>
                        ...
                        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div className="aboutboxes">
                                ...
                                <div className="about2img"><img src="/eldeco-la-vida-bella-images2/images/about2.jpg" alt="About 2 Image" title="About 2 Image" /></div>


                                <div className="livebox-box-outer">
                                    <div className="livebox-box-gray"><img src="/eldeco-la-vida-bella-images2/images/about1.jpg" alt="About 1 Image" title="About 1 Image" /></div>
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link active" id="amenities-tab1-tab" data-toggle="tab"
                                                    ...
                                                    <span className="active-arrow"><img src="/eldeco-la-vida-bella-images2/images/arrow-right-white.png"
                                                        alt="Arrow Right White" title="Arrow Right White" /></span></button>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link" id="amenities-tab2-tab" data-toggle="tab"
                                                    ...
                                                    aria-controls="profile" aria-selected="false"><img className="amenity-icon"
                                                        src="/eldeco-la-vida-bella-images2/images/amenity2.png" alt="Cricket Pitch  Image" title="Cricket Pitch  Image" />Cricket Pitch
                                                    <span className="active-arrow"><img src="/eldeco-la-vida-bella-images2/images/arrow-right-white.png"
                                                        alt="Arrow Right White" title="Arrow Right White" /></span></button>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                    ...
                                    <div className="tabs-content">
                                        <div className="tab-content" id="myTabContent">
                                            ...
                                            <div className="tab-pane fade" id="amenitiestab4" role="tabpanel"
                                                ...
                                                <img className="img-fluid" src="/eldeco-la-vida-bella-images2/images/badminton-court.jpg" alt="Badminton Court" title="Badminton Court" />
                                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                            <div className="text-center"><img src="/eldeco-la-vida-bella-images2/images/updated-logo.png" style={{ width: 140 }}
                                                alt="Updated Logo" title="Updated Logo" /></div>
                                        </div>
